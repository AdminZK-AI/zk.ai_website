...
const painPoints = [
  ...
  { icon: DollarSign, text: 'Verpasste Leads bedeuten verlorenen Umsatz' },
  { icon: Calendar, text: 'Manuelle Terminvereinbarung verschwendet Zeit' },
  { icon: Users, text: 'Support-Teams sind überlastet' },
];

const services = [
  {
    icon: MessageSquare,
    title: 'KI-Chatbots für Unternehmen',
    description: 'Automatisieren Sie Kundeninteraktionen mit menschenähnlichen KI-Antworten.',
    image: 'https://images.unsplash.com/photo-1531746790731-6c087fecd65a?w=600&h=400&fit=crop&q=80'
  },
  {
    icon: Users2,
    title: 'Lead-Generierung & CRM-Integration',
    description: 'Erfassen und qualifizieren Sie Leads mit nahtloser CRM-Synchronisation.',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop&q=80'
  },
  {
    icon: CalendarClock,
    title: 'Terminvereinbarung',
    description: 'Planen Sie Gespräche & Meetings sofort ohne E-Mail-Austausch.',
...
const comingSoonService = {
  id: 'cold-email',
  title: "KI-gesteuerte Kalt-E-Mail-Akquise",
  description: "Mit der KI-gesteuerten Kalt-E-Mail-Akquise können Sie Hunderte von zielgerichteten Kalt-E-Mails an ausgewählte potenzielle Kunden senden – ohne manuellen Aufwand. Die KI erstellt personalisierte Nachrichten und automatisiert den gesamten Sendeprozess, sodass Sie Ihre Outreach-Aktivitäten effizient skalieren können.",
  features: [
    "Intelligente E-Mail-Sequenz-Automatisierung",
...
const benefits = [
  {
    icon: Bot,
    title: 'KI, die sich menschlich anfühlt',
    description: 'Natürliche Sprachverarbeitung für authentische Gespräche'
  },
  {
    icon: Clock3,
    title: 'Spart 100+ Stunden pro Monat',
    description: 'Automatisieren Sie wiederkehrende Aufgaben und konzentrieren Sie sich auf strategisches Wachstum'
  },
  {
    icon: Settings2,
    title: 'Vollständig anpassbar & integriert',
    description: 'Nahtlose Verbindung mit Ihren bestehenden Geschäftssystemen'
  },
  {
    icon: Scale,
    title: 'Skalierbar für alle Größen',
    description: 'Von Startups bis zu Großunternehmen, wachsen Sie in Ihrem Tempo'
  }
];
...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen gradient-bg">
      <Helmet>
        <title>ZK.AI - KI-gesteuerte Geschäftsautomatisierung</title>
        <meta name="description" content="Transformieren Sie Ihr Unternehmen mit KI-gesteuerter Automatisierung. Steigern Sie Ihren Umsatz, reduzieren Sie die Reaktionszeit und automatisieren Sie Kundeninteraktionen mit unseren intelligenten Chatbots." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://zk-ai.agency/de" />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Ihr Unternehmen verliert <span className="text-purple-400">Zeit & Geld</span> ohne KI
            </h2>
          </div>
          ...
          <div className="text-center max-w-3xl mx-auto bg-purple-900/20 backdrop-blur-lg rounded-xl p-8 mt-16">
            <p className="text-xl text-gray-200">
              Mit ZK.AI können Sie Kundeninteraktionen automatisieren, Leads qualifizieren und Termine rund um die Uhr planen, während Sie sich auf das Wachstum konzentrieren.
            </p>
          </div>
        </div>
      ...
      <section id="services" className="py-24 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              KI-gesteuerte <span className="text-purple-400">Automatisierung</span> für skalierbares Wachstum
            </h2>
          </div>
          ...
          <div className="flex justify-center mt-16">
            <CTAButton text="So funktioniert's" />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              >
                ...
                <div className="pt-4">
                  <Link 
                    to={`/de/waitlist?service=${comingSoonService.id}`}
            ...
            <div className="relative h-64 lg:h-auto overflow-hidden">
              <img
                ...
                alt="KI-gesteuerte Kalt-E-Mail-Akquise"
      ...
      >
        ...
        <div className="bg-black/40 backdrop-blur-lg rounded-xl overflow-hidden border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 p-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">Zukünftige KI-Dienste</h3>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Machen Sie sich bereit für unsere nächste Generation KI-gesteuerter Automatisierungslösungen
            </p>
          </div>
              ...
              >
                ...
                <div className="relative bg-black/40 backdrop-blur-lg rounded-xl p-6 border border-purple-500/20 group-hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    >
                      <Link 
                        to={`/de/waitlist?service=${service.id}`}
      ...
      <section id="benefits" className="py-24 px-4 relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">
              Warum Unternehmen <span className="text-purple-400">ZK.AI</span> vertrauen
            </h2>
          </div>
          ...
          <div className="flex justify-center">
            <CTAButton text="Kostenloses KI-Strategiegespräch buchen" />
          </div>
        </div>
